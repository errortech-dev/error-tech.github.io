...
//alert(ghj);
    ...
    a++;
    output+='<tr> <td style="text-align:right"  colspan="9"><b>TOTAL:'+parseInt(xv).toFixed(3)+'&nbsp&nbsp&nbsp&nbsp</b></td>';
    d++;
...
pcs[a]=c;
    ...
    a++;
output+='<tr> <td colspan="9" style="text-align:right"><b>TOTAL:'+parseInt(xv).toFixed(3)+'&nbsp&nbsp&nbsp&nbsp</b></td></tr>';
d++;
...
output+='<tr class="cen"><td style="width:2%">'+item_count+'</td><td style="width:21%" colspan="3" >'+namear[m]+' </td><td style="width:21%" colspan="3" >'+lot[m]+' </td><td style="width:7%">'+pcs[m]+'</td><td colspan="3" style="width:18%">'+parseInt(totalar[m]).toFixed(3)+' </td></tr>';
d++;
}
