function test() {
  ...
  var ghj=xv;
        ...
        a++;
        output+='<tr> <td style="text-align:right"  colspan="6"><b>TOTAL:'+parseInt(xv).toFixed(2)+'&nbsp&nbsp&nbsp&nbsp</b></td>';
        d++;
  ...
  pcs[a]=c;
        totalar[a]=xv;
        a++;
  output+='<tr> <td colspan="6" style="text-align:right"><b>TOTAL:'+parseInt(xv).toFixed(2)+'&nbsp&nbsp&nbsp&nbsp</b></td></tr>';
  d++;
  if(d>=46){
      if(n>3){
         if(d>=51){
  ...
  output+='<tr class="cen"><td style="width:2%">'+item_count+'</td><td style="width:21%"  >'+namear[m]+' </td><td style="width:21%"  >'+lot[m]+' </td><td style="width:7%">'+pcs[m]+'</td><td colspan="2" style="width:18%">'+parseInt(totalar[m]).toFixed(2)+' </td></tr>';
  d++;
  }
  if(d>=46){
      if(n>3){
